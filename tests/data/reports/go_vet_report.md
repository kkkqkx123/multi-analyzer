...
| Line | Column | Level | Message |
|------|--------|-------|---------|
| 7 | 2 | Warning | missing go.sum entry for module providing package github.com/stretchr/testify/assert (imported by example.com/myproject/internal/config); to add: |
| 7 | 2 | Warning | missing go.sum entry for module providing package github.com/stretchr/testify/assert (imported by example.com/myproject/internal/config); to add: |
